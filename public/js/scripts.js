  ...
  try {
    ...
    if (!Array.isArray(reviews) || reviews.length === 0) {
      ...
      if (containerId === 'reviews-container') {
        container.innerHTML += '<p>See my <a href="https://www.google.com/search?q=Sharp+Choice+Real+Estate" target="_blank" rel="noopener noreferrer">Google Reviews</a></p>';
      }
      return;
    }
    ...
    if (containerId === 'reviews-container') {
      ...
      googleReviewCallout.innerHTML = `
        <p>See my <a href="https://www.google.com/search?q=Sharp+Choice+Real+Estate" target="_blank" rel="noopener noreferrer">Google Reviews</a></p>
      `;
